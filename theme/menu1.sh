BURIQ () {
curl -sS https://raw.githubusercontent.com/GoodyOG/instalasi/main/register > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/GoodyOG/instalasi/main/register | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/GoodyOG/instalasi/main/register | awk '{print $4}' | grep $MYIP)
if [ "$MYIP" = "$IZIN" ]; then
Bloman
else
...
Exp=$(curl -sS https://raw.githubusercontent.com/GoodyOG/instalasi/main/register | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/GoodyOG/instalasi/main/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "$(figlet " ZOOLZTHEAZ")" | lolcat
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}ZOOLZTHEAZ${NC}"
echo -e "${BICyan} │"
...
echo -e "${BICyan} │  ${BICyan}DEVELOPER :  ${BIYellow}ZOOLZTHEAZ${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
